...
// --- Slot Universe // ==================== SLOT UNIVERSE & SHIFT HELPERS ==================== Shift Helpers ---
/**
...
const AvailabilityService = {
  ...
  /**
   * Get slot availability for management appointments (VIP links: HK, OK, HMK)
   * Management appointments can have 2 appointments per slot (unlike regular 1 per slot)
   * @param {string} date - Date in YYYY-MM-DD format
   * @param {number} managementLevel - Management level (1, 2, 3)
   * @returns {{success: boolean, slots?: Array, error?: string}} Slot availability
   */
...
// ❌ MOVED TO NAMESPACE: AppointmentService.assignStaff (line ~2064)
// Randevuya personel ata (VIP linkler için)
/* DEPRECATED - Use AppointmentService.assignStaff instead
...
// ❌ MOVED TO NAMESPACE: CalendarService.getGoogleEvents (line ~939)
// Google Calendar'dan mevcut etkinlikleri getir
/* DEPRECATED - Use CalendarService.getGoogleEvents instead
 ...
 */
// ❌ MOVED TO NAMESPACE: AppointmentService.createManual (line ~2123)
/* DEPRECATED - Use AppointmentService.createManual instead
...
/**
 * Script Properties'den external config'leri yükle (ENHANCED)
 * 🔒 SECURITY: Tüm hassas veriler Script Properties'de saklanır
 * ✅ GitHub'a commit edilmez (Script Properties'de saklanır)
 *
 * Production Mode:
 *   - TURNSTILE_SECRET_KEY zorunlu (yoksa hata)
 *   - CALENDAR_ID zorunlu (yoksa 'primary' fallback)
 *
 ...
 */
// ❌ MOVED TO NAMESPACE: AvailabilityService.getManagementSlots (line ~2808)
