...
async function handleResetProfilAyarlari(req: Request): Promise<Response> {
  ...
  const defaults: Record<string, Record<string, unknown>> = {
    g: { same_day_booking: false, max_slot_appointment: 1, slot_grid: 60, max_daily_per_staff: 4, max_daily_delivery: 3, duration: 60, assign_by_admin: false, staff_filter: 'role:sales', show_calendar: true, default_type: 'meeting', show_type_selection: true, vardiya_kontrolu: true },
    ...
    b: { same_day_booking: false, max_slot_appointment: 1, slot_grid: 60, max_daily_per_staff: 4, max_daily_delivery: 3, duration: 60, assign_by_admin: false, staff_filter: 'role:sales', show_calendar: true, default_type: 'meeting', show_type_selection: true, vardiya_kontrolu: true },
